...
export default function FreeToolsPage() {
  ...
  return <><Head><title>Free Trucking Compliance Tools | We Heart Paperwork</title><meta name="description" content="Build a personalized federal paperwork checklist and use free tools for new entrant audits, driver qualification files, maintenance records, accident registers, and MCS-150 due dates." /><link rel="canonical" href="https://weheartpaperwork.com/tools" /></Head><ScrollView style={styles.page} contentContainerStyle={styles.content}><PublicHeader />
