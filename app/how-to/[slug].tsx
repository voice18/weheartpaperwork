...
import { compliancePageBySlug } from "../../lib/publicCompliancePages";
...
export default function HowToDetailPage() {
  ...
  const faqs = compliancePageBySlug[guide.relatedComplianceSlug]?.faqs ?? [];
  ...
  return <>
    ...
    <ScrollView style={styles.page} contentContainerStyle={styles.pageContent}>
      ...
      <View style={styles.article}>
        ...
        {faqs.length ? <View style={styles.faqSection}>
          <Text style={styles.eyebrow}>COMMON QUESTIONS</Text>
          <Text style={styles.sectionTitle}>Straight answers before you start.</Text>
