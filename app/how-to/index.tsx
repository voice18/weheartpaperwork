...
export default function HowToIndexPage() {
  ...
  return <>
    ...
    <ScrollView style={styles.page} contentContainerStyle={styles.pageContent}>
      ...
      <View style={[styles.startHere, compact && styles.startHereCompact]}>
