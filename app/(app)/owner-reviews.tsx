...
export default function OwnerReviews() {
  ...
  } catch(error:any){ setMessage(error?.message || "Unable to load reviews."); } finally { setLoading(false); } },[]);
  ...
  return <ScrollView style={styles.page} contentContainerStyle={styles.content}>
    ...
    {loading?<ActivityIndicator color="#27500A" size="large"/>:<><Text style={styles.section}>Customer feedback</Text>
...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:"#F6F5F1"},content:{width:"100%",maxWidth:760,alignSelf:"center",padding:24,paddingBottom:72},back:{color:"#27500A",fontWeight:"800",marginBottom:30},eyebrow:{color:"#3B6D11",fontSize:12,fontWeight:"800",letterSpacing:1.1},title:{color:"#1A1915",fontSize:40,lineHeight:46,fontWeight:"800",marginTop:8},help:{color:"#5F5D57",fontSize:15,lineHeight:24,marginTop:12,marginBottom:24},section:{fontSize:22,fontWeight:"800",color:"#1A1915",marginTop:18,marginBottom:12},message:{padding:12,backgroundColor:"#EEF4E8",color:"#31551A",borderRadius:8,marginBottom:16},empty:{padding:24,backgroundColor:"#FFF",borderRadius:14,marginBottom:18},emptyTitle:{fontSize:18,fontWeight:"800",color:"#1A1915"},card:{padding:22,backgroundColor:"#FFF",borderWidth:1,borderColor:"#E5E3DA",borderRadius:14,marginBottom:16},feedbackType:{color:"#3B6D11",fontSize:11,fontWeight:"800",letterSpacing:1},stars:{color:"#B36B00",fontSize:20},review:{color:"#1A1915",fontSize:16,lineHeight:25,marginTop:12},name:{fontWeight:"800",color:"#1A1915",marginTop:16},meta:{color:"#706E68",fontSize:12,lineHeight:18,marginTop:4},disclosure:{color:"#854F0B",fontSize:12,lineHeight:18,marginTop:10},actions:{flexDirection:"row",gap:10,marginTop:20},publish:{backgroundColor:"#27500A",borderRadius:9,paddingHorizontal:20,paddingVertical:12},ack:{alignSelf:"flex-start",backgroundColor:"#27500A",borderRadius:9,paddingHorizontal:16,paddingVertical:10,marginTop:16},publishText:{color:"#FFF",fontWeight:"800"},reject:{borderWidth:1,borderColor:"#A32D2D",borderRadius:9,paddingHorizontal:20,paddingVertical:12},rejectText:{color:"#A32D2D",fontWeight:"800"}});
